...
const Order = () => {
    ...
    return (
        <div className='w-[100vw] min-h-[100vh] p-[20px] pb-[150px] overflow-hidden 
                    ...
                    orderData.map((item, index) => (
                        <div key={index} className='w-[100%] h-[10%] border-t border-b'>
                            <div className='w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[[20px] rounded-2xl relative'>
                                <img src={item.image1} alt="" className='w-[130px] h-[130px] rounded-sm' />
                                ...
                                <div className='flex items-start justify-center flex-col gap-[5px]'>
                                    ...
                                    <div className='absolute md:right-[5%] md:top-[40%] right-[1%] top-[70%]'>
                                        <button className='md:px-[15px] md:py-[7px] px-[5px] py-[3px] rounded-sm bg-[#101919] text-[#f3f9fc] text-[12px] md:text-[16px] cursor-pointer active:bg-slate-500' onClick={onlanguagechange}>Track Order</button>
