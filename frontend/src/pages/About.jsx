      ...
      bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]'>
        ...
        <div className='w-[100%] flex items-center justify-center flex-col lg:flex-row'>
          ...
          <div className='lg:w-[50%] w-[100%] flex items-center justify-center'>
            ...
            <img src={about} alt="" className='lg:w-[70%]  w-[80%] shadow-md shadow-black rounded-sm'/>

          </div>

          <div className='lg:w-[50%] w-[100%] px-[20px] flex items-start justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px]'>
            ...
            <p className='lg:w-[80%] w-[100%]  text-white md:text-[16px] text-[13px]'>
              modern shoppers-combining style, convenience, and affordability. Wether it's fashion, essentials, or trends, we bring everything you need to one trusted platform with fast delivery, easy returns, and a customer-first shopping experience you'll love
            </p>
            <p className='lg:w-[80%] w-[100%]  text-[15px] text-white lg:text-[18px] mt-[10px] font-bold'>Our Mission</p>
            <p className='lg:w-[80%] w-[100%] text-white md:text-[16px] text-[13px]'>
              We make fashion simple and affordable, offering stylish, high-quality clothing that fits every occasion — all from the comfort of your home.
            </p>
        ...
        <div className='w-[100%] flex items-center justify-center flex-col gap-[10px]'>
           ...
           <div className='w-[80%] flex items-center justify-center lg:flex-row flex-col py-[40px]'>
            ...
            <div className='lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col px-[40px] py-[10px] text-white backdrop-blur-[2px] bg-[#ffffff0b] overflow-hidden'>

              <b className='text-[20px] font-semibold text-[#bff1f9]'>Exceptional Customer Service</b>

              <p>Our dedicated support team ensures quick responses, helpfull solutions, and a smooth shopping experience every time.</p>
