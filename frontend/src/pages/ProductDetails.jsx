...
const ProductDetails = () => {
    ...
    return productData ? (
        <div>
            ...
            <div className='w-[100vw] h-[130vh] md:h-[100vh] flex items-center justify-start flex-col lg:flex-row bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[20px] '>
                ...
                <div className='lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70px] flex items-center justify-center md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row'>
                    ...
                    <div className='lg:w-[20%] md:w-[80%] h-[10%] lg:h-[80%] flex items-center justify-center gap-[50px] lg:gap-[20px] lg:flex-col flex-wrap'>
                        ...
                        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-[#80808049] rounded-md' onClick={() => setImage(image1)}>
                            <img src={image1} alt="" className='w-[100%] h-[100%] cursor-pointer rounded-md' />
                        </div>

                        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-[#80808049] rounded-md' onClick={() => setImage(image2)}>
                            <img src={image2} alt="" className='w-[100%] h-[100%] cursor-pointer rounded-md' />
                        </div>

                        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-[#80808049] rounded-md' onClick={() => setImage(image3)}>
                            <img src={image3} alt="" className='w-[100%] h-[100%] cursor-pointer rounded-md' />
                        </div>

                        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border-[1px] border-[#80808049] rounded-md' onClick={() => setImage(image4)}>
                    ...
                    <div className='lg:w-[60%] w-[80%] lg:h-[78%] h-[70%] border-[1px] border-[#80808049] rounded-md overflow-hidden'>
                        <img src={image} alt="" className='w-[100%] lg:h-[100%] h-[100%] text-[30px] text-white text-center cursor-pointer rounded-md' />
                    </div>
                ...
                <div className='lg:w-[50vw] w-[100vw] lg:h-[75vh] h-[40vh] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]'>
                    ...
                    <p className='w-[80%] md:w-[60%] text-[20px] font-semibold pl-[5px] text-white'> {productData.description} and Stylish, breathable cotton shirt with a modern slim fit. Easy to wash, super comfortable, and designed for efforless styles.</p>
                    ...
                    <div className='flex flex-col gap-[10px] my-[10px]'>
                        ...
                        <div className='flex gap-2'>
                            {productData.sizes.map((item, index) => (
                                <button
                                    key={index}
                                    className={`border py-2 px-4 bg-slate-600 rounded-md ${item === size ? 'bg-[#86f8b7] text-[20px]' : ''}`}
            ...
            <div className='w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col overflow-x-hidden'>
                ...
                <div className=' flex px-[20px] mt-[90px] lg:ml-[80px] ml-[0px] lg:mt-[0px]'>
                    ...
                    <p className='border px-5 py-3 text-sm text-white'>Reviews</p>
                ...
                <div className='w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px]'>
                    ...
                    <p className='w-[95%] h-[90%] flex items-center justify-center'>
                        Stay comfortable and stylish with our Classic Cotton Casual Shirt. Made from 100% breathable cotton, this shirt is perfect for everyday wear. Its modern slim fit, soft fabric, and versatile design make it easy to pair with jeans, chinos, or shorts. Whether you’re heading to work, a casual outing, or a weekend hangout, this shirt keeps you looking sharp with minimal effort.
                    </p>

                </div>

                <RelativeProduct category={productData.category} subCategory={productData.subCategory} currentProductId={productData._id}/>
