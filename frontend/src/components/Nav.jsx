  ...
  return (
    <div className='w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black'>
      ...
      <div className='w-[20%] lg:w-[30%] flex items-center justify-start gap-[10px]'>
        <img src={vcart} alt="" className='w-[30px]' />
        <h1 className='text-[25px] text-black font-sans'>OneCart</h1>
      </div>

      <div className='w-[50%] lg:w-[40%] hidden md:flex lg:flex'>
      ...
      <div className='w-[30%] flex items-center justify-end gap-[20px]'>
        {!showSearch && <IoSearchCircleOutline className='w-[38px] h-[38px] text-[#000000] cursor-pointer' onClick={()=>setShowSearch(prev=>!prev)}/>}
          ...
          {showSearch && <IoSearchCircleSharp className='w-[38px] h-[38px] text-[#000000] cursor-pointer' onClick={()=>{setShowSearch(prev=>!prev);navigate("/collection")}}/>}
        ...
        <MdOutlineShoppingCart className='w-[30px] h-[30px] hidden md:block text-[#000000] cursor-pointer' onClick={()=>navigate("/cart")}/>
{/* change */}
        <p className='absolute flex w-[18px] h-[18px]  md:block items-center justify-center text-[9px] bg-black px-[5px] py-[2px] text-white rounded-full top-[10px] right-[23px]'>{getCartCount()}</p>
      </div>

      {showSearch && <div className='w-[100vw] h-[80px] bg-[#d8f6f9dd] absolute top-[100%] left-0 right-0 flex items-center justify-center'>
      ...
      {showProfile && <div className='absolute w-[220px] h-[150px] bg-[#000000d7] top-[110%] right-[4%] border-[1px] border-[#aaa9a9] rounded-[10px] z-10'>
        ...
        <div className='w-[100vw] h-[90px] flex items-center justify-between px-[20px] fixed bottom-0 left-0 bg-[#191818] md:hidden text-[12px]'>
          ...
          <button className='text-white flex items-center justify-center flex-col gap-[2px]' onClick={()=>navigate("/cart")}><MdOutlineShoppingCart className='w-[28px] h-[25px] text-white md:hidden'/>Cart</button>
